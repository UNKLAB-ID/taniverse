import imageECommerce from '../../assets/images/e-commerce.svg';
import imageNews from '../../assets/images/news.svg'
...
const data = [
    {
        ...
        description: "Build strong networks and strategic partnerships with companies, farmers, and stakeholders to create mutually beneficial synergies."
    },
    {
        label: "E-Commerce",
        image: <ECommerceIcon />,
        list: [ListImage, ListImage, ListImage],
        description: "Simplify the buying and selling of agricultural products online, with a secure platform that ensures a smooth and reliable transaction process every time."
    },
    {
        label: "AI Agriculture",
        image: <AiIcon />,
        list: [ListImage, ListImage, ListImage],
        description: "Leverage advanced AI technology to accurately detect pests, diseases, and soil conditions, helping you make informed decisions to enhance crop health and maximize yields."
    },
    {
        label: "Digital Distributors & Agents",
        image: <DistributorIcon />,
        list: [ListImage, ListImage, ListImage],
        description: "Easily manage and track the distribution of agricultural products in real-time, ensuring timely deliveries and optimizing your supply chain for maximum efficiency."
    },
    {
        label: "Agricultural News & Research",
        image: <NewsIcons />,
        list: [ListImage, ListImage, ListImage],
        description: "Access the latest information on global and local markets, research, and business opportunities in agriculture to keep you informed and support better decision-making"
    },
]
...
const OurValue = () => {
    ...
    const scroll = (direction: "left" | "right") => {
        ...
        if (container) {
            ...
            } else if (newScrollLeft >= scrollWidth - clientWidth && direction === "right") {
    ...
    return (
        <div className="mx-15 my-30 ">
            <div ref={scrollRef} className="flex overflow-x-auto scroll-smooth snap-x snap-mandatory w-full h-screen scrollbar-none">
                {
                    [...data, ...data].map((item, index) => (
                        <div className="w-full mx-4 flex-shrink-0 grid grid-cols-2 gap-4 snap-center" key={index}>
                            {/* Baris pertama */}
                            <div
                                ...
                                <div className='w-full'>
                                    ...
                                    <div className='flex gap-4 '>
                                        {item.list.map((list, id) => (
                                            <div key={id} className="relative w-[166px] h-[166px] rounded-[16px]">
                                                ...
                                                <img src={list} alt="list" className="w-full h-full object-cover rounded-lg" />
